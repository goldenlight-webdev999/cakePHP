...
<?php 
			...
			?>
			<div style="display: table-cell;vertical-align: middle;"><font style="font-size:18px"><?php if(trim($contactArr['Contact']['name']) !=''){ echo ucfirst($contactArr['Contact']['name']); echo ' ('.$number.')';}else{ echo $number; } ?></font>
			</div>
...
<li><a href="<?php echo SITE_URL ?>/messages/send_message/<?php echo $contactArr['Contact']['id']; ?>/contacts" title="Schedule Message"><i class="fa fa-calendar-plus-o"></i> Schedule Message</a>
            ...
            <div class="actions" style="padding-left: 300px;">
                <?php if(trim($contactArr['Contact']['email']) !='') { ?>
					<a class="btn btn-circle btn-icon-only btn-default fancybox fancybox.iframe" id="pop_fancy" href="<?php echo SITE_URL; ?>/contacts/send_email/<?php echo $contactArr['Contact']['email'];?>" title='Send Email' style="border-color: #f2784b;border-radius: 0px !important;box-shadow:1px 1px 2px -1px rgba(0, 0, 0, 0.52) inset !important">
					    <i class="fa fa-envelope-o" style="margin-top:11px;font-size:22px;color:#f2784b "></i>
					</a>&nbsp;
                <?} ?>
                <a class="btn btn-circle btn-icon-only btn-default nyroModal" href="<?php  echo SITE_URL ?>/chats/notes/<?php echo $contactArr['Contact']['id']; ?>" title="View Notes" style="border-color: #94A0B2;border-radius: 0px !important;box-shadow:1px 1px 2px -1px rgba(0, 0, 0, 0.52) inset !important">
                    <i class="icon-notebook" style="margin-top:11px;font-size:22px;color:#94A0B2 "></i>
                </a>&nbsp;
                <a class="btn btn-circle btn-icon-only btn-default nyroModal" href="<?php  echo SITE_URL ?>/contacts/edit/<?php echo $contactArr['Contact']['id']; ?>/2" title="Edit Contact" style="border-color: #32c5d2;border-radius: 0px !important;box-shadow:1px 1px 2px -1px rgba(0, 0, 0, 0.52) inset !important">
                    <i class="icon-note" style="margin-top:11px;font-size:22px;color:#32c5d2 "></i>
                </a>&nbsp;
