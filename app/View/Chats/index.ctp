...
.text-box .btn-group button.fp__btn{
        ...
        <div id="sound"></div>
								...
								<div class="col-lg-4 col-md-4">
									<!--<div class="portlet box red inlstpr">-->
										...
										<div style="overflow:hidden;height:854px !important" class="portlet-body panel-body inbx-list zx">
											<!--<span class="sdb-srch">
...
<li class="btn ">
															...
															<!--<div class="btn-group icntgsbtns" style="width:80%;height:40px">-->
															
															<div class="btn-group icntgsbtns" style="width:60%;height:40px;padding-top:5px">
 ...
 Insert Template-->
 <a href="<?php echo SITE_URL;?>/chats/msgtemplates" class="nyroModal" title="Message Templates"><i class="fa fa-clone" aria-hidden="true" style="font-size:18px"></i>
 ...
 Insert Short Link-->
 <a href="<?php echo SITE_URL;?>/chats/shortlinks" class="nyroModal" title="Short Links"><i class="fa fa-link" aria-hidden="true" style="font-size:18px"></i>
																	<!--<button class="btn btn-default" type="button">
...
<a class="usractns" id="btntagsmerge" href="javascript:void(0)" title="Merge Tags"><i class="fa fa-tags" style="font-size:18px"></i> 															
																	<!--<button class="btn btn-default" type="button">
																		<i class="fa fa-tags"></i>
																	</button>-->
																</a>&nbsp;&nbsp;&nbsp;
																<?php if (FILEPICKERON == 'Yes'){?>
																<input onchange="popmessagepickwidget(event.fpfile.url)" data-fp-container="modal" data-fp-mimetypes="*/*" data-fp-apikey="<?php echo FILEPICKERAPIKEY; ?>" id="filepicker" style="display: none;margin-top:0px" type="filepicker"/>
																<?php } ?>
...
<div class="save pull-right" id="templates" style="display:none;padding-left:10px">
...
<ul class="msg-chr" style="background:#22313F;width:100%;text-align:center;">
<li>Characters: <span id="characters" style="color:yellow;font-weight:bold">0</span></li>&nbsp;
											   ...
											   <button class="btn btn-success btn-sm" type="button" id="sendsms" onclick="return sendsms()" style="margin-bottom:2px;margin-top:5px;"><i class="fa fa-paper-plane" aria-hidden="true" style="font-size:20px"></i>&nbsp;<font style="font-size:16px">Send</font></button>
											</div>  
