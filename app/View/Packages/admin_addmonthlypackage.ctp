...
<?php echo $this->Form->create('MonthlyPackage',array('style'=>'width:98%'));?>
	<fieldset>
		<legend><?php echo('Add Monthly Package'); ?></legend>
	<?php 
...
'Zambia'=>'Zambia',
'Zimbabwe'=>'Zimbabwe');
	    echo $this->Form->input('product_id',array('type'=>'text','label'=>'<strong>Plan ID</strong>'));
		echo $this->Form->input('package_name');
		
		echo $this->Form->input('amount');
		echo $this->Form->input('text_messages_credit',array('label'=>'<strong>SMS Credits</strong>'));
		echo $this->Form->input('voice_messages_credit',array('label'=>'<strong>Voice Credits</strong>'));
		echo $this->Form->input('credits_carryover',array('type'=>'select','options'=>$CarryOverOption));
