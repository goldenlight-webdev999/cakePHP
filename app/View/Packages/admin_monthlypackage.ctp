...
<div class="packages index" style="margin-right:20px">
	<h2><?php echo('Monthly Packages');?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('text_messages_credit','SMS Credits');?></th>
			<th><?php echo $this->Paginator->sort('voice_messages_credit','Voice Credits');?></th>
			<th><?php echo $this->Paginator->sort('credits_carryover','Credits Carryover');?></th>
	...
	<tr<?php echo $class;?>>
		...
		if($package['MonthlyPackage']['credits_carryover'] == 1){
		echo "Yes";
        ...
        <td><?php echo $package['MonthlyPackage']['username']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'editmonthlypackage', $package['MonthlyPackage']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'monthlydelete', $package['MonthlyPackage']['id']), array('class' => 'delete'), sprintf(__('Are you sure you want to delete?', true))); ?>
			<?php echo $this->Html->link(__('Features', true), array('action' => 'packagepermissions', base64_encode($package['MonthlyPackage']['id']),0),array('class' => 'darkblue nyroModal')); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
