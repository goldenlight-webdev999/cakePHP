...
<?php echo $this->Form->create('Config',array('style'=>'width:98%'));?>
	<fieldset>
		<legend><?php echo('Edit SMS Gateway/Country Association'); ?></legend>

<?php
	echo $this->Form->input('CountryGateway.id',array('type'=>'hidden'));
    echo $this->Form->input('CountryGateway.country', array('disabled'=>true));
    $Option5=array(''=>'Select SMS Gateway','4'=>'Bandwidth','1'=>'Nexmo','3'=>'Plivo','5'=>'Signal Wire','7'=>'Telnyx','0'=>'Twilio','6'=>'Ytel');
