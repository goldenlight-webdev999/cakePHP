...
<?php echo $this->Session->flash(); ?>
    <?php echo $this->Form->create('User',array('action'=> 'login','name'=>'loginForm','id'=>'loginForm'));?>
		...
		<div class="forget-password">
			...
			<p> no worries, click
			<?php echo $this->Html->link('Forgot Password?', array('controller' => 'users', 'action' =>'forgot_password'), array('class' =>'forget-password','style'=>'color:#32c5d2'))?>
			</p>
		</div>
		<div class="create-account">
		    <p> Don't have an account yet ?&nbsp;
			<?php echo $this->Html->link('Create an account',array('controller' =>'users', 'action' => 'add'), array('escape' =>false,'class'=>'uppercase','style'=>'color:#32c5d2'))?>
			</p>
		</div>
