...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Get email notices to your registered email address for incoming text messages to your online number(SMS to Email). You can then respond directly to that email from your email client, the system will take that email and text them back(Email to SMS)" data-original-title="Email To SMS/SMS To Email" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
					...
					<br/>
					<fieldset>
						<legend><font style="font-size:20px">Broadcast From Phone</font>&nbsp;<a href="javascript:;" data-container="body" data-html="true" data-trigger="hover" data-content="Blast out your SMS marketing campaigns with a simple text message! Below is the phone number the text will be coming from. <br/><br/>Format - send [group keyword]: message. Example: send pizza: stop in today to receive a 20% discount on all large pizzas!<br/><br/><b>NOTE: </b>This feature is recommended to only broadcast to small groups(< 50). When sending to large groups, please use the Bulk SMS feature." data-original-title="Broadcast From Phone" class="popovers"><i class="fa fa-question-circle" style="font-size:18px"></i> </a></legend>
						<div class="feildbox">
