...
jQuery(function(){
   ...
   if($('#api_type').val() == 2){
	 ...
	 $("#showkeys").hide();
	 $("#showauth").hide();
	 $("#showbandwidthuserid").hide();
	 $("#showsignalwirespace").hide();
  }else if ($('#api_type').val() == 4){ 
     $('#showslooce').hide();
	 $("#shownumberlimit").show();
	 $("#showkeys").show();
	 $("#showauth").show();
     $("#showbandwidthuserid").show();
     $("#showsignalwirespace").hide();
   }else if ($('#api_type').val() == 5){ 
     $('#showslooce').hide();
	 $("#shownumberlimit").show();
	 $("#showkeys").show();
	 $("#showauth").show();
     $("#showbandwidthuserid").hide();
     $("#showsignalwirespace").show();
   }else if ($('#api_type').val() == 7){ 
     $('#showslooce').hide();
	 $("#shownumberlimit").show();
	 $("#showkeys").show();
	 $("#showauth").hide();
...
'Zimbabwe'=>'Zimbabwe');
		...
		echo $this->Form->input('sms_balance', array('label' => 'SMS Credits'));
        //if(API_TYPE !=2){
        if($api_type !=2){
           echo '<div id=shownumber>';
		   echo $this->Form->input('voice_balance', array('label' => 'Voice Credits'));
		   //echo $this->Form->input('assigned_number', array('label' => 'Local Number'));
		   echo '</div>';
		}else{
		   echo '<div id=shownumber style=display:none>';
		   echo $this->Form->input('voice_balance',array('label' => 'Voice Credits'));
		   //echo $this->Form->input('assigned_number', array('label' => 'Local Number'));
		   echo '</div>';
		}
		...
		//if($api_type !=2){
		   $Option5=array(''=>'Select SMS Gateway','4'=>'Bandwidth','1'=>'Nexmo','3'=>'Plivo','5'=>'Signal Wire','2'=>'Slooce','7'=>'Telnyx','0'=>'Twilio','6'=>'Ytel');
		...
		//if(API_TYPE==2){
		if($api_type ==2){
		    echo '<div id=showkeys style=display:none>';
	        echo $this->Form->input('sid',array('id'=>'sid','label' => 'SMS Gateway ID/Key','placeholder'=>'Only enter if user is using their own gateway account'));
	        //echo $this->Form->input('authtoken',array('id'=>'authtoken','label' => 'SMS Gateway Token/Secret','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        
	        echo '<div id=showauth style=display:none>';
	        echo $this->Form->input('authtoken',array('id'=>'authtoken','label' => 'SMS Gateway Token/Secret','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	    
		    echo '<div id=shownumberlimit style=display:none>';
		    ...
		    echo '<div id=showkeys>';
	        echo $this->Form->input('sid',array('id'=>'sid','label' => 'SMS Gateway ID/Key','placeholder'=>'Only enter if user is using their own gateway account'));
	        //echo $this->Form->input('authtoken',array('id'=>'authtoken','label' => 'SMS Gateway Token/Secret','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        
	        echo '<div id=showauth>';
	        echo $this->Form->input('authtoken',array('id'=>'authtoken','label' => 'SMS Gateway Token/Secret','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        
	        echo '<div id=showbandwidthuserid>';
	        echo $this->Form->input('bandwidthuserid',array('label' => 'Bandwidth User ID','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        
	        echo '<div id=showsignalwirespace style=display:none>';
	        echo $this->Form->input('signalwirespace',array('label' => 'Signal Wire Space URL','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        ...
	        echo '<div id=showbandwidthuserid style=display:none>';
	        echo $this->Form->input('bandwidthuserid',array('label' => 'Bandwidth User ID','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        
	        echo '<div id=showsignalwirespace>';
	        echo $this->Form->input('signalwirespace',array('label' => 'Signal Wire Space URL','placeholder'=>'Only enter if user is using their own gateway account'));
	        echo '</div>';
	        ...
	        //echo '<div id=showtelnyxkey>';
	        //echo $this->Form->input('telnyxsid',array('id'=>'telnyxsid','label' => 'SMS Gateway ID/Key','placeholder'=>'Only enter if user is using their own gateway account'));
	        //echo '</div>';
	        ...
	        //echo '<div id=showtelnyxkey style=display:none>';
	        //echo $this->Form->input('telnyxsid',array('id'=>'telnyxsid','label' => 'SMS Gateway ID/Key','placeholder'=>'Only enter if user is using their own gateway account'));
	        //echo '</div>';
		...
		if($api_type ==2){
			...
			echo $this->Form->input('slooce.assigned_number', array('label' => 'Short Code','value'=>$assigned_number));
			echo '</div>';
		}else{
