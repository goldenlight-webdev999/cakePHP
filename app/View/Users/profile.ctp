			 ...
			 <?php echo $this->Session->flash(); ?>
               ...
               <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum">
                        ...
                        <div class="details">
                            <div class="desc" style = "margin-top : 5px;"> Your current plan is </div>
                            <div class="number" style = "padding-top:0px;font-weight: bold;">
                                <?php
                                $currentPlan = "Pay & Go";
                                if(!empty($packages)){
                                    $currentPlan = ucfirst($packages['MonthlyPackage']['package_name']);
                                }
                                print $currentPlan;
                               ?>
                            </div>
                            <div class="desc">
                                ...
                                if (checkdate($month,$day,$year)){
                                    print "Next renewal <b>" . date('M d, Y',$date) . "</b>";
                                 }
                                }
                                ?>
                                </b>
                        ...
                        <span class="more" style="padding:0px;opacity:1;filter:alpha(opacity=100);">
                            <a class="more nyroModal" style="opacity:1" href="<?php echo SITE_URL;?>/users/purchaseplan?plan=<?php print urlencode($currentPlan); ?>"> <font ><b>Click to upgrade plan</b></font>
                                ...
                                if($loggedUser['User']['assigned_number']>0 && $loggedUser['User']['active']=='1' && (REQUIRE_MONTHLY_GETNUMBER == 0 || (REQUIRE_MONTHLY_GETNUMBER == 1 && $loggedUser['User']['package'] > 0))){ ?>
									<?php if($loggedUser['User']['number_limit_count'] < $loggedUser['User']['number_limit']){ ?>
										...
										<?php }else if(API_TYPE==4){?>
											<a style="opacity:1" class="more nyroModal" href="<?php echo SITE_URL;?>/bandwidths/searchcountry"> <font style="color:yellow"><b>Get New Number</b></font>
												<i class="m-icon-swapright m-icon-white"></i>
											</a>
										<?php }else if(API_TYPE==5){?>
											<a style="opacity:1" class="more nyroModal" href="<?php echo SITE_URL;?>/signalwires/searchcountry"> <font style="color:yellow"><b>Get New Number</b></font>
												<i class="m-icon-swapright m-icon-white"></i>
											</a>
										<?php }else if(API_TYPE==6){?>
											<a style="opacity:1" class="more nyroModal" href="<?php echo SITE_URL;?>/ytels/searchcountry"> <font style="color:yellow"><b>Get New Number</b></font>
												<i class="m-icon-swapright m-icon-white"></i>
											</a>	
										...
										<?php }else if(API_TYPE==7){?>
											<a style="opacity:1" class="more nyroModal" href="<?php echo SITE_URL;?>/telnyxs/searchcountry"> <font style="color:yellow"><b>Get New Number</b></font>
												<i class="m-icon-swapright m-icon-white"></i>
											</a>	
								...
								<div class="scroller-footer">
									<div class="btn-arrow-link pull-right">
										...
										<?php }else if(API_TYPE==3){?>
											...
											<i class="icon-arrow-right"></i>
										<?php } else if(API_TYPE==4){?>
											<a href="<?php echo SITE_URL;?>/users/viewallnumber_bandwidth">See All Records</a>
											<i class="icon-arrow-right"></i>
										<?php } else if(API_TYPE==5){?>
											<a href="<?php echo SITE_URL;?>/users/viewallnumber_signalwire">See All Records</a>
											<i class="icon-arrow-right"></i>
										<?php } else if(API_TYPE==6){?>
											<a href="<?php echo SITE_URL;?>/users/viewallnumber_ytel">See All Records</a>
											<i class="icon-arrow-right"></i>	
										<?php } else if(API_TYPE==7){?>
											<a href="<?php echo SITE_URL;?>/users/viewallnumber_telnyx">See All Records</a>
											<i class="icon-arrow-right"></i>	
										<?php } ?>
									</div>
								</div>
