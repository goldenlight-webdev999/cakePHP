					...
					<div class="row">
						<div class="col-md-12">
							...
							<table class="table table-bordered table-striped">
                                    ...
                                    <!--<tr>												
										<td style="width:15%"> <?php if ($i % 2 == 0) echo $class;?><?php echo('User Account Name'); ?> </td>
										<td style="width:35%">
											<span class="text-muted"> 
												<?php if ($i++ % 2 == 0) echo $class;?>
									...
									<tr>												
										...
										<td style="width:35%">
											<span class="text-muted"> 
												...
												?>
												<a href="<?php echo $value; ?>"><img src="<?php echo $value; ?>" height="100px" width="100px" /></a>
												<?php } } else{?>
													<a href="<?php echo $log['Log']['image_url'] ?>"><img src="<?php echo $log['Log']['image_url'] ?>" height="100px" width="100px" /></a>
												<?php } }		?>
											</span>
										</td>
									</tr>
