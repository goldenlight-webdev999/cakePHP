...
<div style="margin-bottom:10px">
								...
								<div class="form-group">
									...
									&nbsp;<!--<a href="javascript:;" data-container="body" data-trigger="hover" data-html="true" data-content="Use <b>%%CURRENTDATE%%</b> to output the current date in the responder message that gets sent to your subscribers" data-original-title="Merge Tags" class="popovers"><i class="fa fa-tags" style="font-size:18px"></i></a>-->
									<a href="javascript:;" data-container="body" data-trigger="hover" data-html="true" data-content="<b>%%CURRENTDATE%%</b>, <b>%%Name%%</b>, <b>%%Email%%</b>, <b>%%City%%</b>, <b>%%State%%</b>, <b>%%Postal%%</b>, <b>%%Custom1%%</b>, <b>%%Custom2%%</b>, <b>%%Custom3%%</b>" data-original-title="Available Merge Tags" class="popovers"><i class="fa fa-tags" style="font-size:18px;color:#26C281"></i></a>
