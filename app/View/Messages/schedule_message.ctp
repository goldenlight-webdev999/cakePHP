				...
				<!--<div class="table-scrollable">
						...
						<?php 
							...
							if($ScheduleMessages['ScheduleMessage']['msg_type']==1){
							    ...
							    $msg_type='MMS';
							}else if($ScheduleMessages['ScheduleMessage']['msg_type']==3){
							    $message=$ScheduleMessages['ScheduleMessage']['message'];
							    $msg_type='VOICE';
							}
							if ($i++ % 2 == 0) {
						...
						<!--<tbody>-->
							<tr <?php echo $class;?>> 
								...
								<td><?php echo $ScheduleMessages['ScheduleMessage']['city'] ?></td>
								<td><?php echo $ScheduleMessages['ScheduleMessage']['state'] ?></td>
								<td><?php echo $ScheduleMessages['ScheduleMessage']['zip'] ?></td>

								<?php if(strpos($ScheduleMessages['ScheduleMessage']['message'],"http") !== false && $ScheduleMessages['ScheduleMessage']['msg_type']==3) {?>
								    <td>
						                <audio class="audio" controls="controls">
							            <source src=<?php echo $message; ?> type="audio/mpeg">
						                </audio>
						             </td>
						        <? }else { ?>        
						...
						<?php   } ?>
                                ...
                                <?php if($ScheduleMessages['ScheduleMessage']['msg_type']==3){
                                      echo $this->Html->link('<i class="icon-note" style="font-size:14px"></i>',array('controller'=>'groups','action'=>'edit_broadcast',$ScheduleMessages['ScheduleMessage']['voice_id']),array('class'=> 'btn green btn-sm','escape'=> false,'title'=>'Edit','style'=>'margin-right:0px')); 
								}else{ 
                                      echo $this->Html->link('<i class="icon-note" style="font-size:14px"></i>',array('action'=>'edit',$ScheduleMessages['ScheduleMessage']['id']),array('class'=> 'btn green btn-sm','escape'=> false,'title'=>'Edit','style'=>'margin-right:0px')); 
                                } ?>
