...
function is_gsm(instring){
     var valid_gsm_keycodes = ['@','Δ',' ','0','¡','P','¿','p',
        '£','_','!','1','A','Q','a','q',
        '$','Φ','"','2','B','R','b','r',
        '¥','Γ','#','3','C','S','c','s',
        'è','Λ','¤','4','D','T','d','t',
...
$country = $users['User']['user_country'];
?>	
...
<?php } ?>
							...
							<div id="showHideDiv1" style="display:none;">
								...
								<label for="some21">Name|Group Name|Phone Number&nbsp;<a href="javascript:;" data-container="body" data-trigger="hover" data-html="true" data-content="Only the most recent 1000 contacts added will be returned in this list. This is to prevent slow load times with very large lists and large form submissions." data-original-title="Contacts Returned" class="popovers"><i class="fa fa-question-circle" style="font-size:18px"></i></a></label></br>
							...
							<div id="showHideDiv3" style="display:none;">
							  ...
							  <?php echo $this->Form->input('Message.city',array('div'=>false,'label'=>false, 'class' => 'form-control input-xlarge','id'=>'city','maxlength'=>'50','placeholder'=>'', 'title'=>''))?>
                              </div>
							  <?php if($country=="United States") {
                                    ...
                                    <?php echo $this->Form->input('Message.state',array('type' =>'select','class' =>'form-control input-xlarge', 'div'=>false,'label'=>false, 'options'=>$states))?>
                                    </div>
                                    ...
                                    <input type="text" class="form-control input-xlarge" id="zipcode" name="data[Message][zip]"  />
                                    </div>
                                    </fieldset>
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-html="true" data-content="Please schedule your messages to be sent from 8:00AM - 9:00PM local time to adhere to the applicable guidelines published by the CTIA and the Mobile Marketing Association<br><br><b>NOTE: </b>It's best to schedule your bulk SMS so that sending is handled as a background process and doesn't tie up the user panel. If you want to send now, just leave the schedule delivery to the current date/time and it will be sent next time the job is ran." data-original-title="Schedule Time" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>

</label>
								<?php 
								echo $this->Form->input('User.shedule',array('readonly' => 'readonly','required' => 'required','div'=>false,'label'=>false, 'class' => 'form-control input-xlarge','id'=>'sent_on','value'=>date('d-m-Y H:i')))
								?>								
							...
							<?php if(API_TYPE==0){ ?>	
								<div class="form-group">
									<div class="radio-list">
										...
										<?php } else { ?>
										MMS<input type="radio" value="2" name="data[Message][msg_type]" id="mms" disabled/>
										<? } ?>
									</div>
								</div>
...
<a href="javascript:;" data-html="true" data-container="body" data-trigger="hover" data-content="Useful if you have a large number of opt-in contacts(>500), you can spread your workload across multiple numbers in your account.<br/><br/><b>STICKY SENDER:</b> Even when rotating through your numbers, your contacts will always get the message from the same recognizable phone number to create a consistent experience and maintain conversation history." data-original-title="Longcodes Rotate" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
						...
						<div class="form-actions">
							<?php echo $this->Form->submit('Send Message',array('div'=>false,'class'=>'btn blue'));?>
						</div>
