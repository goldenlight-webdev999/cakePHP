...
<label style="font-size:20px;padding-bottom:10px">Kiosk Buttons</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox-inline">
													...
													<label class="col-sm-6">
                                                        <input type="checkbox" name="data[Kiosk][city]" id="city" <?php if($Kioskslist['Kiosks']['city']==1){ echo "checked"; }?>> City
													</label>
													<label class="col-sm-6">
                                                        <input type="checkbox" name="data[Kiosk][state]" id="state" <?php if($Kioskslist['Kiosks']['state']==1){ echo "checked"; }?>> State/Province
													</label>
													<label class="col-sm-6">
                                                        <input type="checkbox" name="data[Kiosk][zip]" id="zip" <?php if($Kioskslist['Kiosks']['zip']==1){ echo "checked"; }?>> Postal Code
													</label>
                                                </div>
                                            </div>
                                        </div>
