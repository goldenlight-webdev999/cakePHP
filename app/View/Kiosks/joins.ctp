...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<style>
		...
		.input3{ display:inline-block; padding:0px; width:63.2%;font-size: 20px;height: 36px;}
	...
	<div class="container" id="submit_form" style="display:none;">
		<div class="button-box1">
			...
			<form method="post" action="">
				...
				<div class="row"><label>First Name:</label>  <input type="text" class="input2" id="firstname" name="firstname" placeholder="First Name"  /></div>
				<?php } ?>
				<?php if($kiosks['Kiosks']['lastname']==1){ $capture=1?>
				<div class="row"><label>Last Name:</label> <input type="text" class="input2" id="lastname" name="lastname" placeholder="Last Name" /></div>
				<?php } ?>
				<?php if($kiosks['Kiosks']['email']==1){ $capture=1?>
				<div class="row"><label>Email:</label> <input type="email" class="input2" id="email" name="email" placeholder="Email"  /></div>
				<?php } ?>
				<?php if($kiosks['Kiosks']['dob']==1){ $capture=1?>
				<div class="row"><label>Date of Birth:</label> <input type="text" class="input2"  id="UserDate" name="date" placeholder="Date of Birth (mm/dd/yyyy)" /></div>
				<?php } ?>
				<?php if($kiosks['Kiosks']['city']==1){ $capture=1?>
				<div class="row"><label>City:</label> <input type="text" class="input2"  id="city" name="city" placeholder="City" /></div>
				<?php } ?>
				<?php if($kiosks['Kiosks']['state']==1){ $capture=1;
                ...
                ?>
                <div class="row"><label>State:</label><?php echo $this->Form->input('state',array('type' =>'select','class' =>'input3', 'label'=>false,'div'=>false,'options'=>$states))?></div>
                ...
                ?>
                <div class="row"><label>Province:</label><?php echo $this->Form->input('state',array('type' =>'select','class' =>'input3', 'div'=>false,'label'=>false, 'options'=>$states))?></div>
                <?php }} ?>
				<!--<div class="row"><label>State/Province:</label> <input type="text" class="input2"  id="state" name="state" placeholder="State/Province" /></div>-->

				<?php if($kiosks['Kiosks']['zip']==1){ $capture=1?>
				<div class="row"><label>Postal Code:</label> <input type="text" class="input2"  id="zip" name="zip" placeholder="Postal Code" /></div>
				<?php } ?>
			    <?php if($capture==1) { ?>
