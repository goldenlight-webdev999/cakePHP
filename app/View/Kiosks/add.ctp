...
<label style="font-size:20px;padding-bottom:10px">Kiosk Buttons</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox-inline">
													...
													<label class="col-sm-6">
                                                        <input type="checkbox" name="data[Kiosk][city]" id="city"> City
													</label>
													<label class="col-sm-6">
                                                        <input type="checkbox" name="data[Kiosk][state]" id="state"> State/Province
													</label>
													<label class="col-sm-6">
                                                        <input type="checkbox" name="data[Kiosk][zip]" id="zip"> Postal Code
													</label>
                                                </div>
                                            </div>
                                        </div>
...
<?php } ?>	
		...
		<script>
            jQuery(function(){
                ...
                });jQuery("#loyaltyprogram").validate({
                    expression: "if (VAL) return true; else return false;",
