				   ...
				   <?php echo $this->Form->create('Poll',array('action'=> 'edit/'.$id));?>
					<div class="form-body">
						<div class="form-group">
							...
							<?php echo $this->Form->textarea('Question.question',array('div'=>false,'label'=>false,'class'=>'form-control','id'=>'message1','maxlength'=>'50','value'=>$questionedits[0]['Question']['question']))?>
						</div>
						<!--<div class="form-group">
						...
						<div class="form-group">
							<label>Option A <span class="required_star"><b>* (Required)</b></span></label>
							<div class="input">
							 <input type="text" name="data[Option][optiona][]" class='form-control' id="optiona" class="inputtext" maxlength="20" value="<?php  echo  $questionedits[0]['Option']['optiona']?>" style="background-color:#edf6ff">						 
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option A will get sent after a subscriber votes A" data-original-title="Autoresponder A" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							...
							<div class="input">
								...
								<input type="text" name="data[Option][autorsponder_message][]" class='form-control' id="autoresponder1" maxlength="160" value="<?php  echo  $questionedits[0]['Option']['autorsponder_message']?>" >							
							</div>
						</div>
						<div class="form-group">							
								<label>Option B <span class="required_star"><b>* (Required)</b></span></label>
							<div class="input">						
								<input type="text" name="data[Option][optiona][]"id="optionb" class='form-control' maxlength="20"  value="<?php echo $questionedits[1]['Option']['optiona']?>" style="background-color:#edf6ff">
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option B will get sent after a subscriber votes B" data-original-title="Autoresponder B" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							...
							<div class="input">							
								<input type="text" name="data[Option][autorsponder_message][]" class='form-control' id="autoresponder2" maxlength="160" value="<?php  echo  $questionedits[1]['Option']['autorsponder_message']?>" >
							</div>
						</div>
						<div class="form-group">
							<label>Option C</label>
							<div class="input">						
								<input type="text" name="data[Option][optiona][]" id="optionc" class='form-control' maxlength="20"  value="<?php echo  $questionedits[2]['Option']['optiona']?>">
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option C will get sent after a subscriber votes C" data-original-title="Autoresponder C" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							...
							<div class="input">							
								<input type="text" name="data[Option][autorsponder_message][]" class='form-control' id="autoresponder3" maxlength="160" value="<?php  echo  $questionedits[2]['Option']['autorsponder_message']?>"  >
							</div>
						</div>
						<div class="form-group">
							<label>Option D</label>
							<div class="input">						
								<input type="text" name="data[Option][optiona][]" id="optiond" class='form-control' maxlength="20"  value="<?php echo $questionedits[3]['Option']['optiona']?>">
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option D will get sent after a subscriber votes D" data-original-title="Autoresponder D" data-original-title="Autoresponder D" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							...
							<div class="input">						
								<input type="text" name="data[Option][autorsponder_message][]" class='form-control' id="autoresponder4" maxlength="160" value="<?php  echo  $questionedits[3]['Option']['autorsponder_message']?>" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input">						
								<input type="text" name="data[Option][optiona][]" id="optione" class='form-control' maxlength="20"  value="<?php echo $questionedits[4]['Option']['optiona']?>">
							</div>
						</div>
						<div class="form-group">
							<label>Autoresponder message Option E <!--<a rel="tooltip" title="Please enter Autoresponder message Option D" class="ico" href="#" title="help"><i class="fa fa-question-circle" style="font-size:18px"></i></a>	-->
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option E will get sent after a subscriber votes E" data-original-title="Autoresponder E" data-original-title="Autoresponder E" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							</label>
							<div class="input">						
								<input type="text" name="data[Option][autorsponder_message][]" class='form-control' id="autoresponder5" maxlength="160" value="<?php  echo  $questionedits[4]['Option']['autorsponder_message']?>" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input">						
								<input type="text" name="data[Option][optiona][]" id="optionf" class='form-control' maxlength="20"  value="<?php echo $questionedits[5]['Option']['optiona']?>">
							</div>
						</div>
						<div class="form-group">
							<label>Autoresponder message Option F <!--<a rel="tooltip" title="Please enter Autoresponder message Option D" class="ico" href="#" title="help"><i class="fa fa-question-circle" style="font-size:18px"></i></a>	-->
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option F will get sent after a subscriber votes F" data-original-title="Autoresponder F" data-original-title="Autoresponder F" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							</label>
							<div class="input">						
								<input type="text" name="data[Option][autorsponder_message][]" class='form-control' id="autoresponder6" maxlength="160" value="<?php  echo  $questionedits[5]['Option']['autorsponder_message']?>" >
							</div>
						</div>
						...
						<?php echo $this->Form->textarea('Question.autoreply_message',array('div'=>false,'label'=>false,'class'=>'form-control','id'=>'message','maxlength'=>'160','value'=>$questionedits[5]['Question']['autoreply_message']))?>   
						</div>
					</div>
