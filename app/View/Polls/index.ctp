				   ...
				   <?php echo $this->Form->create('Poll',array('action'=> 'index'));?>
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="input">
							 <input type="text" name="data[Option][optiona][]" id="optiona" class="form-control" maxlength="20" style="background-color:#edf6ff">							 
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option A will get sent after a subscriber votes A" data-original-title="Autoresponder A" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
						...
						<div class="form-group">							
							...
							<div class="input">						
								<input type="text" name="data[Option][optiona][]"id="optionb" class="form-control" maxlength="20" style="background-color:#edf6ff"> 
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option D will get sent after a subscriber votes D" data-original-title="Autoresponder D" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
						...
						<div class="form-group">
							...
							<div class="input">						
								<input type="text" name="data[Option][optiona][]" id="optione" class="form-control" maxlength="20">
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option E will get sent after a subscriber votes E" data-original-title="Autoresponder E" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							</label>
							<div class="input">						
								<input type="text" name="data[Option][autorsponder_message][]" class="form-control" maxlength="160" id="autoresponder5" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input">						
								<input type="text" name="data[Option][optiona][]" id="optionf" class="form-control" maxlength="20">
							</div>
						</div>
						<div class="form-group">
...
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Autoresponder message Option F will get sent after a subscriber votes F" data-original-title="Autoresponder F" class="popovers"> <i class="fa fa-question-circle" style="font-size:18px"></i> </a>
							</label>
							<div class="input">						
								<input type="text" name="data[Option][autorsponder_message][]" class="form-control" maxlength="160" id="autoresponder6" >
							</div>
						</div>
