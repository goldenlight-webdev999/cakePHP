...
<?php echo $this->Form->create('Bandwidth', array('controller'=> 'bandwidths', 'action'=> 'sendsms/1', 'id' => 'sendMsgForm', 'onsubmit'=>' return validate()'));?>
...
<br>
Purchase Number to use this feature by <b><?php echo $this->Html->link('Get Number', array('controller' =>'bandwidths', 'action' =>'searchcountry'), array('class' => 'nyroModal' ,'style'=>'color:#ff0000;'))?>.</b><br />
