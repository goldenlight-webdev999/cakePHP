				...
				<div class="portlet-body form">
					...
					<div class="form-body">													
						...
						<div class="form-group">
							...
							<?php if(API_TYPE==6){?>&nbsp;<a href="javascript:;" data-html="true" data-container="body" data-trigger="hover" data-content="To send ringless voicemail, you must upload a MP3 audio file. You will then see the ringless voicemail action button on the list page. Please make sure the audio file is between 30-60 seconds in length." data-original-title="Ringless Voicemail" class="popovers"><i class="fa fa-question-circle" style="font-size:18px"></i></a>
							<?} ?>
							</br>
