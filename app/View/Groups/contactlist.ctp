...
<?php echo $this->Html->link('<i class="icon-bubble" style="font-size:14px"></i>',array('action'=>'plivo_send_sms',$group['Contact']['phone_number']),array('class'=> 'btn green-jungle btn-sm nyroModal','escape'=> false,'title'=>'Send SMS','style'=>'margin-right:0px'));?>											
                                                <?php }else if(API_TYPE==4){ ?>
                                                      <!--<?php echo $this->Html->link(__('Send SMS', true), array('action' => 'bandwidth_send_sms', $group['Contact']['phone_number']), array('class' => 'btn blue btn-outline btn-sm nyroModal')); ?>-->

<?php echo $this->Html->link('<i class="icon-bubble" style="font-size:14px"></i>',array('action'=>'bandwidth_send_sms',$group['Contact']['phone_number']),array('class'=> 'btn green-jungle btn-sm nyroModal','escape'=> false,'title'=>'Send SMS','style'=>'margin-right:0px'));?>
                                                <?php }else if(API_TYPE==5){ ?>
									<!--<?php echo $this->Html->link(__('Send SMS', true), array('action' => 'signalwire_send_sms', $group['Contact']['phone_number']), array('class' => 'btn blue btn-outline btn-sm nyroModal')); ?>-->

<?php echo $this->Html->link('<i class="icon-bubble" style="font-size:14px"></i>',array('action'=>'signalwire_send_sms',$group['Contact']['phone_number']),array('class'=> 'btn green-jungle btn-sm nyroModal','escape'=> false,'title'=>'Send SMS','style'=>'margin-right:0px'));?>
												<?php }else if(API_TYPE==6){ ?>
									<!--<?php echo $this->Html->link(__('Send SMS', true), array('action' => 'ytel_send_sms', $group['Contact']['phone_number']), array('class' => 'btn blue btn-outline btn-sm nyroModal')); ?>-->

<?php echo $this->Html->link('<i class="icon-bubble" style="font-size:14px"></i>',array('action'=>'ytel_send_sms',$group['Contact']['phone_number']),array('class'=> 'btn green-jungle btn-sm nyroModal','escape'=> false,'title'=>'Send SMS','style'=>'margin-right:0px'));?>
                                                <?php }else if(API_TYPE==7){ ?>
                                                									<!--<?php echo $this->Html->link(__('Send SMS', true), array('action' => 'ytel_send_sms', $group['Contact']['phone_number']), array('class' => 'btn blue btn-outline btn-sm nyroModal')); ?>-->
                                                
                                                <?php echo $this->Html->link('<i class="icon-bubble" style="font-size:14px"></i>',array('action'=>'telnyx_send_sms',$group['Contact']['phone_number']),array('class'=> 'btn green-jungle btn-sm nyroModal','escape'=> false,'title'=>'Send SMS','style'=>'margin-right:0px'));?>
												<?php }} ?>
