...
<span class="btn default btn-file">
                                                                ...
                                                                <?php if(API_TYPE==6) { ?>
                                                                <input type="hidden" value="" name="..."><input type="file" id="files" name="data[Group][image][]" onclick="check_image()" > </span><!--<a data-dismiss="fileinput" class="btn red fileinput-exists" href="javascript:;"> Remove </a>-->
                                                                <?} else { ?>
