...
function generatePopUpURL () {
    ...
    if(trim($("#urlLogo").val())!='https://' && trim($("#urlLogo").val()) != ""){
        if((typeFile!='png' && typeFile!='jpg' && typeFile!='gif')){   
            ...
            if ($("#CollectCity").prop("checked")) {
                urlParams += '&cc=1';
            } else {
                urlParams += '&cc=0';
            }    
            
            if ($("#CollectState").prop("checked")) {
                urlParams += '&cs=1';
            } else {
                urlParams += '&cs=0';
            }    
            
            if ($("#CollectZip").prop("checked")) {
                urlParams += '&cz=1';
            } else {
                urlParams += '&cz=0';
            }    
...
<label><strong>Collect City:</strong>&nbsp;
</label>
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Check this box if you want to collect city on the sign-up form." data-original-title="Collect City" class="popovers"><i class="fa fa-question-circle" style="font-size:18px"></i></a>
									<input name="CollectCity" id="CollectCity" style="vertical-align: top;" class="form-control" type="checkbox">
									
<label><strong>Collect State/Province:</strong>&nbsp;
</label>
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Check this box if you want to collect state/province on the sign-up form." data-original-title="Collect State/Province" class="popovers"><i class="fa fa-question-circle" style="font-size:18px"></i></a>
									<input name="CollectState" id="CollectState" style="vertical-align: top;" class="form-control" type="checkbox">
									
<label><strong>Collect Postal Code:</strong>&nbsp;
</label>
<a href="javascript:;" data-container="body" data-trigger="hover" data-content="Check this box if you want to collect postal code on the sign-up form." data-original-title="Collect Postal Code" class="popovers"><i class="fa fa-question-circle" style="font-size:18px"></i></a>
									<input name="CollectZip" id="CollectZip" style="vertical-align: top;" class="form-control" type="checkbox">									
</div>
<!--*****-->
