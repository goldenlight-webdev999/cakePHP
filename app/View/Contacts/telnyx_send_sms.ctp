...
<!--<?php echo $this->Form->create('Telnyx', array('controller'=> 'telnyxs', 'action'=> 'sendsms', 'id' => 'sendMsgForm', 'onsubmit'=>' return validate()'));?>-->
<form name="Telnyx" id="sendMsgForm" method="post" action="<?php echo SITE_URL?>/telnyxs/sendsms" enctype="multipart/form-data" onsubmit="return validate()">
...
<br>
Purchase Number to use this feature by <b><?php echo $this->Html->link('Get Number', array('controller' =>'telnyxs', 'action' =>'searchcountry'), array('class' => 'nyroModal' ,'style'=>'color:#ff0000;'))?>.</b><br />
