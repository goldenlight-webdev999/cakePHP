...
$.extend(DayGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		if(event.sent == 1){
			var viewlink = htmlEscape(siteurl+'/schedulers/events_view_cal/'+'/'+event.event_id);
			titleHtml =
				'<span class="fc-title" onClick="viewfunction(\''+htmlEscape(viewlink)+'\');">' +
					(htmlEscape(event.title.substring(0,20) || '') || '&nbsp;') + // we always want one line of height
				'</span>';
			return '<div class="fc-content fc-day-grid-event fc-eventsent fc-start fc-end">' +
					(isRTL ?
			...
			titleHtml =
				'<span class="fc-title" onClick="viewfunction(\''+htmlEscape(viewlink)+'\');">' +
					(htmlEscape(event.title.substring(0,20) || '') || '&nbsp;') + // we always want one line of height
				'</span>';
			var deletelink = htmlEscape(siteurl+'/schedulers/events_delete/'+event.event_id);
			var deletelinks = htmlEscape(siteurl+'/schedulers/multi_event_delete/'+event.recurring_id);
			
			if(event.msg_type !=3){
    			if(event.recurring_id > 0){
    			   return '<div class="fc-content fc-day-grid-event fc-event fc-start fc-end">' +
    					(isRTL ?
    						titleHtml + ' ' + timeHtml : // put a natural space in between
    						timeHtml + ' ' + titleHtml   //
    						) +
    				'<div style="float:right;"><span style="color:red;float:left;padding-left: 4px;"><span onClick="editfunction(\''+htmlEscape(event.url)+'\');"><img src="'+siteurl+'/scheduler/fullcalendar/pencil.png"></span></span><span style="color:red;float:left;padding-left: 4px;"><span onClick="confirmfunction(\''+deletelink+'\');"><img src="'+siteurl+'/scheduler/fullcalendar/cross.png" title="Delete single event in the series"></span></span><span style="color:red;float:left;padding-left: 4px;"><span onClick="confirmfunction_multi(\''+deletelinks+'\');"><img src="'+siteurl+'/scheduler/fullcalendar/cross.png" title="Delete all events in the series"></span></span></div><div class="clearfix"></div></div>' +
    				(isResizable ?
    					'<div class="fc-resizer"/>' :
    					''
    				) ;
    				...
    				'<div style="float:right;"><span style="color:red;float:left;padding-left: 4px;"><span onClick="editfunction(\''+htmlEscape(event.url)+'\');"><img src="'+siteurl+'/scheduler/fullcalendar/pencil.png"></span></span><span style="color:red;float:left;padding-left: 4px;"><span onClick="confirmfunction(\''+deletelink+'\');"><img src="'+siteurl+'/scheduler/fullcalendar/cross.png"></span></span></div><div class="clearfix"></div></div>' +
    				(isResizable ?
    					'<div class="fc-resizer"/>' :
    					''
    				) ;
			   ...
			   return '<div class="fc-content fc-day-grid-event fc-event fc-start fc-end" style="background-color: #8775a7">' +
    					(isRTL ?
    						titleHtml + ' ' + timeHtml : // put a natural space in between
    						timeHtml + ' ' + titleHtml   //
    						) +
    				'<div style="float:right;"><span style="color:red;float:left;padding-left: 4px;"><a href="'+htmlEscape(event.url)+'"><img src="'+siteurl+'/scheduler/fullcalendar/pencil.png"></a></span><span style="color:red;float:left;padding-left: 4px;"><span onClick="confirmfunction(\''+deletelink+'\');"><img src="'+siteurl+'/scheduler/fullcalendar/cross.png"></span></span></div><div class="clearfix"></div></div>' +
...
$.extend(TimeGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		//var viewlink = htmlEscape('http://learnwp.me/calendars/request'+'/'+event.event_id);
		var titleHtmls =	'<span class="fc-title">' +
				(htmlEscape(event.title.substring(0,100) || '') || '&nbsp;') + // we always want one line of height
			'</span>';

		return '<span style="font-size:12px !important;" onClick="editfunction(\''+event.url+'\');" class="' + classes.join(' ') + '"' +
			(skinCss ?
				' style="' + skinCss + '"' :
				''
				) +
			'>' +
				'<div class="fc-content">' +
					...
					(event.title ? '</div>' + titleHtmls + '</div>' :'') +
				'</div>' +
				'<div class="fc-bg"/>' +
				(isResizable ?
					'<div class="fc-resizer"/>' :
